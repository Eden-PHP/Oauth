 ...
 */
class Collection extends Base implements \ArrayAccess, \Iterator, \Serializable, \Countable 
{
    const ERROR_NOT_SUB_MODEL = 'Class %s is not a child of Eden\\Utility\\Model';

    const FIRST = 'first';
    const LAST = 'last';
    const MODEL = 'Eden\\Utility\\Model';
     ...
     *
     * @param array|Eden\Utility\Model
     * @return Eden\Utility\Block
     */
    public function add($row = array()) 
    {
        //Argument 1 must be an array or Eden\Utility\Model
    ...
    public function setModel($model) 
    {
        ...
        if(!is_subclass_of($model, 'Eden\\Utility\\Model')) {
            Exeption::i()
